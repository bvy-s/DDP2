...
train_classes = list(range(unseen_class))  # 0 to 29

n_domains = len(domains)
train_domains = ['dslr', 'webcam']
...
for d in domains:
    full_dataset = datasets.ImageFolder(f'~/bhavyaaa/datasets/office31/{d}', transform=transform)
